...
export const DE_CH_EXERCISE_CATEGORIES: ExerciseCategory[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      {
        id: 'de-ch-stories-einhorn-am-see',
        name: 'Einhorn am See',
        expectedChars: ['L', 'u', 'n', 'a', ' ', 'd', 'a', 's', ' ', 'E', 'i', 'n', 'h', 'o', 'r', 'n', ' ', 'm', 'a', 'c', 'h', 't', 'e', ' ', 'e', 'i', 'n', 'e', 'n', ' ', 'S', 'p', 'a', 'z', 'i', 'e', 'r', 'g', 'a', 'n', 'g', ' ', 'e', 'n', 't', 'l', 'a', 'n', 'g', ' ', 'd', 'e', 's', ' ', 'S', 'e', 'e', 's', '.', ' ', 'D', 'a', 's', ' ', 'W', 'a', 's', 's', 'e', 'r', ' ', 'w', 'a', 'r', ' ', 'b', 'l', 'a', 'u', ' ', 'u', 'n', 'd', ' ', 'r', 'u', 'h', 'i', 'g', '.', ' ', 'S', 'i', 'e', ' ', 's', 'a', 'h', ' ', 'k', 'l', 'e', 'i', 'n', 'e', ' ', 'F', 'i', 's', 'c', 'h', 'e', ' ', 'u', 'n', 'd', ' ', 's', 'c', 'h', 'ö', 'n', 'e', ' ', 'B', 'l', 'u', 'm', 'e', 'n', ' ', 'a', 'm', ' ', 'U', 'f', 'e', 'r', '.', ' ', 'L', 'u', 'n', 'a', ' ', 'f', 'ü', 'h', 'l', 't', 'e', ' ', 's', 'i', 'c', 'h', ' ', 'g', 'l', 'ü', 'c', 'k', 'l', 'i', 'c', 'h', ' ', 'u', 'n', 'd', ' ', 'r', 'u', 'h', 'i', 'g', '.'],
        impactedKeys: ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'O', 'P', 'R', 'S', 'T', 'U', 'W', 'Z', 'Ö', 'Ü', ' ', '.']
      },
      {
        id: 'de-ch-stories-dinosaurier-faehrt-auto',
        name: 'Dinosaurier fährt Auto',
        expectedChars: ['R', 'e', 'x', ' ', 'd', 'e', 'r', ' ', 'D', 'i', 'n', 'o', 's', 'a', 'u', 'r', 'i', 'e', 'r', ' ', 's', 't', 'i', 'e', 'g', ' ', 'i', 'n', ' ', 's', 'e', 'i', 'n', ' ', 'r', 'o', 't', 'e', 's', ' ', 'A', 'u', 't', 'o', ' ', 'u', 'n', 'd', ' ', 'f', 'u', 'h', 'r', ' ', 'd', 'i', 'e', ' ', 'S', 't', 'r', 'a', 's', 's', 'e', ' ', 'e', 'n', 't', 'l', 'a', 'n', 'g', '.', ' ', 'E', 'r', ' ', 'h', 'u', 'p', 't', 'e', ' ', 'e', 'i', 'n', 'e', 'm', ' ', 'S', 'c', 'h', 'a', 'f', ' ', 'u', 'n', 'd', ' ', 'w', 'i', 'n', 'k', 't', 'e', ' ', 'e', 'i', 'n', 'e', 'r', ' ', 'K', 'u', 'h', '.', ' ', 'D', 'e', 'r', ' ', 'g', 'r', 'o', 's', 's', 'e', ' ', 'D', 'i', 'n', 'o', 's', 'a', 'u', 'r', 'i', 'e', 'r', ' ', 'l', 'ä', 'c', 'h', 'e', 'l', 't', 'e', ' ', 'u', 'n', 'd', ' ', 'f', 'u', 'h', 'r', ' ', 'w', 'e', 'i', 't', 'e', 'r', '.'],
        impactedKeys: ['A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'O', 'P', 'R', 'S', 'T', 'U', 'W', 'X', 'Ä', ' ', '.']
      }
    ]
  }
];
