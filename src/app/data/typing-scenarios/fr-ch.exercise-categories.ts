...
export const FR_CH_EXERCISE_CATEGORIES: ExerciseCategory[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      {
        id: 'fr-ch-histoires-la-licorne-au-bord-du-lac',
        name: 'La licorne au bord du lac',
        expectedChars: ['L', 'u', 'n', 'a', ' ', 'l', 'a', ' ', 'l', 'i', 'c', 'o', 'r', 'n', 'e', ' ', 's', 'e', ' ', 'p', 'r', 'o', 'm', 'e', 'n', 'a', 'i', 't', ' ', 'l', 'e', ' ', 'l', 'o', 'n', 'g', ' ', 'd', 'u', ' ', 'l', 'a', 'c', '.', ' ', 'L', '\'', 'e', 'a', 'u', ' ', 'é', 't', 'a', 'i', 't', ' ', 'b', 'l', 'e', 'u', 'e', ' ', 'e', 't', ' ', 't', 'r', 'a', 'n', 'q', 'u', 'i', 'l', 'l', 'e', '.', ' ', 'E', 'l', 'l', 'e', ' ', 'v', 'i', 't', ' ', 'd', 'e', ' ', 'p', 'e', 't', 'i', 't', 's', ' ', 'p', 'o', 'i', 's', 's', 'o', 'n', 's', ' ', 'e', 't', ' ', 'd', 'e', ' ', 'j', 'o', 'l', 'i', 'e', 's', ' ', 'f', 'l', 'e', 'u', 'r', 's', ' ', 'p', 'r', 'è', 's', ' ', 'd', 'e', ' ', 'l', 'a', ' ', 'r', 'i', 'v', 'e', '.', ' ', 'L', 'u', 'n', 'a', ' ', 's', 'e', ' ', 's', 'e', 'n', 't', 'a', 'i', 't', ' ', 'h', 'e', 'u', 'r', 'e', 'u', 's', 'e', ' ', 'e', 't', ' ', 's', 'e', 'r', 'e', 'i', 'n', 'e', '.'],
        impactedKeys: ['A', 'B', 'C', 'D', 'E', 'È', 'É', 'F', 'G', 'H', 'I', 'J', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', '\'', ' ', '.']
      },
      {
        id: 'fr-ch-histoires-le-dinosaure-conduit',
        name: 'Le dinosaure conduit',
        expectedChars: ['R', 'e', 'x', ' ', 'l', 'e', ' ', 'd', 'i', 'n', 'o', 's', 'a', 'u', 'r', 'e', ' ', 'm', 'o', 'n', 't', 'a', ' ', 'd', 'a', 'n', 's', ' ', 's', 'a', ' ', 'v', 'o', 'i', 't', 'u', 'r', 'e', ' ', 'r', 'o', 'u', 'g', 'e', ' ', 'e', 't', ' ', 'r', 'o', 'u', 'l', 'a', ' ', 's', 'u', 'r', ' ', 'l', 'a', ' ', 'r', 'o', 'u', 't', 'e', '.', ' ', 'I', 'l', ' ', 'k', 'l', 'a', 'x', 'o', 'n', 'n', 'a', ' ', 'd', 'e', 'v', 'a', 'n', 't', ' ', 'u', 'n', ' ', 'm', 'o', 'u', 't', 'o', 'n', ' ', 'e', 't', ' ', 's', 'a', 'l', 'u', 'a', ' ', 'u', 'n', 'e', ' ', 'v', 'a', 'c', 'h', 'e', '.', ' ', 'L', 'e', ' ', 'g', 'r', 'a', 'n', 'd', ' ', 'd', 'i', 'n', 'o', 's', 'a', 'u', 'r', 'e', ' ', 's', 'o', 'u', 'r', 'i', 't', ' ', 'e', 't', ' ', 'c', 'o', 'n', 't', 'i', 'n', 'u', 'a', ' ', 's', 'a', ' ', 'r', 'o', 'u', 't', 'e', '.'],
        impactedKeys: ['A', 'C', 'D', 'E', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'O', 'R', 'S', 'T', 'U', 'V', 'X', ' ', '.']
      }
    ]
  }
];
