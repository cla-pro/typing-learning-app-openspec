...
- **WHEN** exercise component requirements tests are executed
- **THEN** tests verify centered stream alignment, unlabeled pressed-key feedback sizing, single-control rendering, side-segment overflow behavior assumptions, and left-shift progression updates
